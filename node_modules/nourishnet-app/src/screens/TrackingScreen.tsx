...
const TrackingScreen: React.FC = () => {
  ...
  const setupNotifications = async () => {
    try {
      ...
      if (status === 'granted') {
        // Schedule notification for delivery updates
  ...
  const handleSupport = () => {
    Alert.alert(
      ...
      [
        { text: 'Call Vendor', onPress: () => Linking.openURL('tel:+919876543210') },
  ...
  const handleChatSupport = () => {
    Alert.alert('Chat Support', 'Chat feature will be implemented with real-time messaging');
  };
